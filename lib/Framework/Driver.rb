	...
	module Framework
		...
		class Driver
			...
			def run report_level = :smart
				...
				source_db_connection = Util::Configuration::get_config @mapping.source_db_connection
				target_db_connection = Util::Configuration::get_config @mapping.target_db_connection
				max_row = Util::Configuration::get_config :MAX_ROW
				dc = Core::DataContainer.new @mapping, source_db_connection, target_db_connection, max_row
