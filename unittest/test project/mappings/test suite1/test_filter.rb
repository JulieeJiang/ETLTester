...
# puts test_mapping.source_sql_generator.generate_sql + " where " + test_mapping.source_filter

# ds = ETLTester::Util::DBConnection.get_data_from_db({type: :oracle, address: "ITR2ITG_DEDICATED", user: "infr", password: "INFR_INFR_2011.bb"},
#  test_mapping.source_sql_generator.generate_sql + " where " + test_mapping.source_filter)
